...
class DeepScansTest {
  ...
  fun parse_should_get_String_list() {
    ...
    LARGE_PARSED_JSON.resolveAsType<List<String>>("$..name") shouldBe expected
    LARGE_PARSED_JSON.resolveAsType<List<String>>("$..name") shouldBe expected
  }

  @Test
  fun parse_should_get_Double_list() {
    LARGE_PARSED_JSON.resolveAsType<List<Double>>("$..latitude") shouldBe listOf(
      -85.888651,
      71.831798,
      78.266157,
      -10.214391,
  ...
  fun parse_should_get_JsonArray() {
    ...
    LARGE_PARSED_JSON.resolveAsType<JsonElement>("$..tags")?.toString() shouldBe expected
    LARGE_PARSED_JSON.resolveAsType<JsonElement>("$..['tags']")?.toString() shouldBe expected
  }

  @Test
  fun parse_should_get_from_longer_path() {
    LARGE_PARSED_JSON.resolveAsType<List<String>>("$[2]..name") shouldBe listOf(
      "Marie Hampton",
      "Felecia Bright",
      "Maryanne Wiggins",
      "Marylou Caldwell",
  ...
  fun parse_should_scan_to_get_the_first_item_of_all_sublists() {
    LARGE_PARSED_JSON.resolveAsType<JsonElement>("$[2]..[0]")
  ...
  fun parse_should_scan_to_get_the_last_item_of_all_sublists() {
    LARGE_PARSED_JSON.resolveAsType<JsonElement>("$[2]..[-1]")
  ...
  fun parse_should_scan_to_get_the_first_and_third_items_of_all_sublists() {
    LARGE_PARSED_JSON.resolveAsType<JsonElement>("$[2]..[0,2]")
  ...
  fun parse_should_scan_to_get_the_third_and_all_following_items_of_all_sublists() {
    LARGE_PARSED_JSON.resolveAsType<JsonElement>("$[2]..[2:]")
  ...
  fun parse_should_scan_to_get_all_items_between_first_and_last_of_all_sublists_both_sides_exclusive() {
    LARGE_PARSED_JSON.resolveAsType<JsonElement>("$[2]..[1:-1]")
  ...
  fun parse_should_scan_to_get_all_items_from_second_to_last_to_4th_item_of_all_sublists() {
    LARGE_PARSED_JSON.resolveAsType<JsonElement>("$[2]..[-2:5]")
  ...
  fun parse_should_scan_to_keys_on_different_level_of_all_sublists() {
    LARGE_PARSED_JSON.resolveAsType<JsonElement>("$[2]..['name','company','id']")
  ...
  fun parse_should_scan_to_get_all_items_after_the_first_of_all_sublists_even_if_end_out_of_range() {
    LARGE_PARSED_JSON.resolveAsType<JsonElement>("$[2]..[1:100]")
